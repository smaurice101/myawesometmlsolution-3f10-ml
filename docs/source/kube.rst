Scaling [myawesometmlsolution-3f10-ml] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlsolution-3f10-ml] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlsolution-3f10-ml.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolution-3f10-ml.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolution-3f10-ml.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlsolution-3f10-ml.yml

myawesometmlsolution-3f10-ml.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlsolution-3f10-ml.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-3f10/ymls/myawesometmlsolution-3f10-ml
...
.. code-block:: YAML
   ...
   ################# myawesometmlsolution-3f10-ml.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlsolution-3f10-ml
     spec:
       selector:
         matchLabels:
           app: myawesometmlsolution-3f10-ml
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlsolution-3f10-ml
             image: maadsdocker/myawesometmlsolution-3f10-ml-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'myawesometmlsolution-3f10-ml'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ml_dag-myawesometmlsolution-3f10'
             - name: GITUSERNAME
               value: 'smaurice101'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolution-3f10-ml-visualization-service
       labels:
         app: myawesometmlsolution-3f10-ml-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolution-3f10-ml 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolution-3f10-ml.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolution-3f10-ml.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolution-3f10-ml.yml
