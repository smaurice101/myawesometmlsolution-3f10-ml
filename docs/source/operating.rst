[myawesometmlsolution-3f10-ml] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolution-3f10-ml] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolution-3f10-ml] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   http://localhost:9689/?topic=&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   maadsdocker/myawesometmlsolution-3f10-ml-amd64 (https://hub.docker.com/r/maadsdocker/myawesometmlsolution-3f10-ml-amd64)
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=myawesometmlsolution-3f10-ml \
          --env SOLUTIONDAG=solution_preprocessing_ml_dag-myawesometmlsolution-3f10 \
          ...
          maadsdocker/myawesometmlsolution-3f10-ml-amd64
...
[myawesometmlsolution-3f10-ml] Github Repo
---------------
...
.. important::
   https://myawesometmlsolution-3f10-ml.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-myawesometmlsolution-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44003, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39017, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43027, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42293, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40827, HPDEHOST=127.0.1.1, HPDEPORT=32939, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33243

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3919-myawesometmlsolution-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolution-3f10, python-predict-3752-myawesometmlsolution-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolution-3f10, python-preprocess-9680-myawesometmlsolution-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolution-3f10, python-ml-6741-myawesometmlsolution-3f10-ml,solution_preprocessing_ml_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
